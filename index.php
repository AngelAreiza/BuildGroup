...
<div class="bg-dark text-white text-center position-relative" style="background: url('img/fondo1.jpg') no-repeat center center/cover; height: 100vh;">
    <div class="position-absolute top-50 start-50 translate-middle d-flex align-items-center justify-content-center flex-wrap" style="padding-top: 25px; width: 80%; max-width: 1200px;">
        <!-- Sección de Texto -->
        <section id="box-left">
            <h1>Build Group</h1>
        ...
        <section id="form-right">
            <h2>¡Hacemos realidad tus ideas! 💡🛠️</h2>
                <form method="post" enctype="multipart/form-data">
                    ...
                    <input type="file" accept="pdf" name="pdf" id="pdf" required>
